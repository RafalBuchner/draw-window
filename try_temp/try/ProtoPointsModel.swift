...
class ProtoPointsModel {
    var myStartPoint    = RBPoint(x: 50+200,  y: 50+200+200)
    var myControlPoint1 = RBPoint(x: 50+30+200,  y: 250)
    var myControlPoint2 = RBPoint(x: 400-30+200, y: 250+200)
    var myEndPoint      = RBPoint(x: 400+200, y: 50+200)
